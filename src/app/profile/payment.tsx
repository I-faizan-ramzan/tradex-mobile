  ...
  return (
    <SafeAreaView className="flex-1 bg-white dark:bg-dark-background">
      ...
      >
        ...
        <TouchableOpacity
          onPress={() =>
            setActiveMethod(activeMethod === "paypal" ? null : "paypal")
          }
        ...
        {activeMethod === "paypal" && (
          <View className="bg-white dark:bg-[#1C1C1E] p-6 rounded-3xl mb-6 border border-gray-100 dark:border-white/5 shadow-sm">
            <Text className="text-lg font-bold text-gray-900 dark:text-white mb-6 text-center">
              Paypal Setting
            </Text>
            ...
            <TextInput
              ...
              className="w-full bg-white dark:bg-[#0A0A0A] border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 mb-4 text-gray-900 dark:text-white"
            />
            ...
            <TextInput
              placeholder="Email Confrim"
              placeholderTextColor="#9CA3AF"
              className="w-full bg-white dark:bg-[#0A0A0A] border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 mb-6 text-gray-900 dark:text-white"
            />
            ...
            <View className="flex-row gap-4 mb-2">
              ...
              <TouchableOpacity
                className="flex-1 bg-gray-200 dark:bg-gray-800 py-3.5 rounded-full items-center"
        ...
        {activeMethod === "card" && (
          <View className="bg-white dark:bg-[#1C1C1E] p-6 rounded-3xl mb-6 border border-gray-100 dark:border-white/5 shadow-sm">
            ...
            <TextInput
              placeholder="123 0086 098236 1862"
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            setActiveMethod(activeMethod === "bank" ? null : "bank")
          }
        >
