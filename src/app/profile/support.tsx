      ...
      <View className="flex-1 px-5 mt-4">
        <View className="bg-surface dark:bg-dark-card p-4 rounded-2xl shadow-sm border border-gray-100 dark:border-white/5 mb-6">
          ...
          <Text className="text-gray-500 mb-4">
            Search our knowledge base or get in touch with a specialist.
          </Text>
        ...
        {[
          ...
          <TouchableOpacity
            key={q}
            className="flex-row justify-between items-center py-4 border-b border-gray-100 dark:border-white/5"
          >
