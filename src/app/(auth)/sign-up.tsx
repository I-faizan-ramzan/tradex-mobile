            ...
            <ScrollView className="flex-1 px-6 pt-6" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
                ...
                <View className="gap-3 mb-8">
                    <TouchableOpacity className="w-full flex-row items-center justify-center py-3.5 rounded-full bg-black dark:bg-[#131313] border border-transparent dark:border-white/10 shadow-sm">
                        <FontAwesome name="apple" size={18} color="white" style={{ position: 'absolute', left: 24 }} />
                        <Text className="text-white font-semibold text-[15px]">Continue with Apple</Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity className="w-full flex-row items-center justify-center py-3.5 rounded-full bg-white dark:bg-[#F3F4F6] border border-gray-200 dark:border-transparent shadow-sm">
                        <FontAwesome name="google" size={18} color="#EA4335" style={{ position: 'absolute', left: 24 }} />
                        <Text className="text-gray-900 font-semibold text-[15px]">Continue with Google</Text>
                    </TouchableOpacity>

                    <TouchableOpacity className="w-full flex-row items-center justify-center py-3.5 rounded-full bg-[#1877F2] shadow-sm">
                        <FontAwesome name="facebook" size={18} color="white" style={{ position: 'absolute', left: 24 }} />
